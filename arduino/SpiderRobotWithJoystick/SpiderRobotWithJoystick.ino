...
// added variables for joystick
const int SW_pin = 5; // buttonu , daca il apesi valoare se face in 0 , pin digital
const int x_pin = 2; // pinu 2 , axa X , poate trebuie sa modific ptr robot , conectez la un pin analog daca vreau sa il schimb , e pinu 2 ptr ca arduino UNO pin analog 2 // pe A2
const int y_pin = 0; // pin 0 axa y , pin analog // trebe conectat la A0 pe placa nano
